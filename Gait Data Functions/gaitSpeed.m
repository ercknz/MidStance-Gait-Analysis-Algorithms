...
%% Reset Drift
waist.Step.resetVel =       resetDrift(waist.Step.vel, waist.Step.avgTimes);
rightAnkle.Step.resetVel =  resetDrift(rightAnkle.Step.vel, rightAnkle.Step.avgTimes);
leftAnkle.Step.resetVel =   resetDrift(leftAnkle.Step.vel, leftAnkle.Step.avgTimes);
